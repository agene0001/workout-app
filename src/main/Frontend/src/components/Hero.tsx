...
let heroHeadingStyle: CSSProperties = {textAlign: 'center', fontSize: '4rem', padding: '1.5rem'};
let subHeadingStyle: CSSProperties = {textAlign: 'center', fontSize: '2.5rem'}
    ...
    return (
        <>
            ...
            <div className='container2'>
                <svg id="visual" className='svgBg' viewBox="0 0 920 200" xmlns="http://www.w3.org/2000/svg"
                     version="1.1">
            ...
            <div className="container-fluid text-center vh-100 align-content-center py-3" id="hero3">
                <div ref={myRef3} className='row py-3'>
                    <InfoBlock animation={`${blocks ? 'infoHero' : ''}`} bg='bg-danger' heading={infoTitle} text={[`This is an info block. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa fugit
                           in iste
                    ...
                    <InfoBlock animation={`${blocks ? 'infoHero1' : ''}`} bg='bg-danger' heading={infoTitle1} text={[`This is an info block. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa fugit
                           in iste
                           libero magni molestiae neque quod. Accusantium aspernatur cupiditate delectus deleniti
                           deserunt dicta
                           facere fugit iure nihil officiis, quis quo rem saepe sed sit tempore temporibus unde
