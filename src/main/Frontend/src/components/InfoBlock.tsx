...
function InfoBlock(props: { heading: string, text: string, icon: string | null, animation: string,bg:string }) {
    ...
    return (
        <div ref={ref} className={`${props.animation} ${props.bg} col p-3 m-4 rounded-3 infoBlock`}>
