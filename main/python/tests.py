...
ingredient_test_cases = [
    ...
    ("1 small bunch swiss chard or mustard greens stems removed leaves chopped", [{'name': 'chard', 'display_text': '1 small bunch swiss chard or mustard greens stems removed leaves', 'quantity': '1', 'unit': 'bunch'}]),
    ...
    ("2 tablespoons unsalted butter melted cooled plus more for brushing", [{'name': 'unsalted butter', 'display_text': '2 tablespoons unsalted butter', 'quantity': '2', 'unit': 'tablespoons'}])
]
